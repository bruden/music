...
public final class GrpcServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.AddSongRequest,
      team.burden.music.protos.Grpc.AddSongResponse> getAddSongMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addSong",
      requestType = team.burden.music.protos.Grpc.AddSongRequest.class,
      responseType = team.burden.music.protos.Grpc.AddSongResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.AddSongRequest,
      team.burden.music.protos.Grpc.AddSongResponse> getAddSongMethod() {
    io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.AddSongRequest, team.burden.music.protos.Grpc.AddSongResponse> getAddSongMethod;
      ...
      synchronized (GrpcServiceGrpc.class) {
        if ((getAddSongMethod = GrpcServiceGrpc.getAddSongMethod) == null) {
          GrpcServiceGrpc.getAddSongMethod = getAddSongMethod =
              io.grpc.MethodDescriptor.<team.burden.music.protos.Grpc.AddSongRequest, team.burden.music.protos.Grpc.AddSongResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "addSong"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.AddSongRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.AddSongResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QueryAllSongsRequest,
      team.burden.music.protos.Grpc.QueryAllSongsResponse> getQueryAllSongsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "queryAllSongs",
      requestType = team.burden.music.protos.Grpc.QueryAllSongsRequest.class,
      responseType = team.burden.music.protos.Grpc.QueryAllSongsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QueryAllSongsRequest,
      team.burden.music.protos.Grpc.QueryAllSongsResponse> getQueryAllSongsMethod() {
    io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QueryAllSongsRequest, team.burden.music.protos.Grpc.QueryAllSongsResponse> getQueryAllSongsMethod;
      ...
      synchronized (GrpcServiceGrpc.class) {
        if ((getQueryAllSongsMethod = GrpcServiceGrpc.getQueryAllSongsMethod) == null) {
          GrpcServiceGrpc.getQueryAllSongsMethod = getQueryAllSongsMethod =
              io.grpc.MethodDescriptor.<team.burden.music.protos.Grpc.QueryAllSongsRequest, team.burden.music.protos.Grpc.QueryAllSongsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "queryAllSongs"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.QueryAllSongsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.QueryAllSongsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QuerySongRequest,
      team.burden.music.protos.Grpc.QuerySongResponse> getQuerySongMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "querySong",
      requestType = team.burden.music.protos.Grpc.QuerySongRequest.class,
      responseType = team.burden.music.protos.Grpc.QuerySongResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QuerySongRequest,
      team.burden.music.protos.Grpc.QuerySongResponse> getQuerySongMethod() {
    io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QuerySongRequest, team.burden.music.protos.Grpc.QuerySongResponse> getQuerySongMethod;
    if ((getQuerySongMethod = GrpcServiceGrpc.getQuerySongMethod) == null) {
      synchronized (GrpcServiceGrpc.class) {
        if ((getQuerySongMethod = GrpcServiceGrpc.getQuerySongMethod) == null) {
          GrpcServiceGrpc.getQuerySongMethod = getQuerySongMethod =
              io.grpc.MethodDescriptor.<team.burden.music.protos.Grpc.QuerySongRequest, team.burden.music.protos.Grpc.QuerySongResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "querySong"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.QuerySongRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.QuerySongResponse.getDefaultInstance()))
  ...
  public static abstract class GrpcServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addSong(team.burden.music.protos.Grpc.AddSongRequest request,
        io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.AddSongResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getAddSongMethod(), responseObserver);
    }

    /**
     */
    public void queryAllSongs(team.burden.music.protos.Grpc.QueryAllSongsRequest request,
        io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.QueryAllSongsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getQueryAllSongsMethod(), responseObserver);
    }

    /**
     */
    public void querySong(team.burden.music.protos.Grpc.QuerySongRequest request,
        io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.QuerySongResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                team.burden.music.protos.Grpc.AddSongRequest,
                team.burden.music.protos.Grpc.AddSongResponse>(
                  this, METHODID_ADD_SONG)))
          .addMethod(
            getQueryAllSongsMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                team.burden.music.protos.Grpc.QueryAllSongsRequest,
                team.burden.music.protos.Grpc.QueryAllSongsResponse>(
                  this, METHODID_QUERY_ALL_SONGS)))
          .addMethod(
            getQuerySongMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                team.burden.music.protos.Grpc.QuerySongRequest,
                team.burden.music.protos.Grpc.QuerySongResponse>(
  ...
  public static final class GrpcServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GrpcServiceBlockingStub> {
    ...
    /**
     */
    public team.burden.music.protos.Grpc.AddSongResponse addSong(team.burden.music.protos.Grpc.AddSongRequest request) {
    ...
    /**
     */
    public team.burden.music.protos.Grpc.QueryAllSongsResponse queryAllSongs(team.burden.music.protos.Grpc.QueryAllSongsRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public team.burden.music.protos.Grpc.QuerySongResponse querySong(team.burden.music.protos.Grpc.QuerySongRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GrpcServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GrpcServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<team.burden.music.protos.Grpc.AddSongResponse> addSong(
        team.burden.music.protos.Grpc.AddSongRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<team.burden.music.protos.Grpc.QueryAllSongsResponse> queryAllSongs(
        team.burden.music.protos.Grpc.QueryAllSongsRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<team.burden.music.protos.Grpc.QuerySongResponse> querySong(
        team.burden.music.protos.Grpc.QuerySongRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_SONG:
          serviceImpl.addSong((team.burden.music.protos.Grpc.AddSongRequest) request,
              (io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.AddSongResponse>) responseObserver);
          break;
        case METHODID_QUERY_ALL_SONGS:
          serviceImpl.queryAllSongs((team.burden.music.protos.Grpc.QueryAllSongsRequest) request,
              (io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.QueryAllSongsResponse>) responseObserver);
          break;
        case METHODID_QUERY_SONG:
          serviceImpl.querySong((team.burden.music.protos.Grpc.QuerySongRequest) request,
              (io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.QuerySongResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GrpcServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return team.burden.music.protos.Grpc.getDescriptor();
    }
