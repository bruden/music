...
public final class GrpcServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QuerySongsRequest,
      team.burden.music.protos.Grpc.QuerySongsResponse> getQuerySongsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "querySongs",
      requestType = team.burden.music.protos.Grpc.QuerySongsRequest.class,
      responseType = team.burden.music.protos.Grpc.QuerySongsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QuerySongsRequest,
      team.burden.music.protos.Grpc.QuerySongsResponse> getQuerySongsMethod() {
    io.grpc.MethodDescriptor<team.burden.music.protos.Grpc.QuerySongsRequest, team.burden.music.protos.Grpc.QuerySongsResponse> getQuerySongsMethod;
    if ((getQuerySongsMethod = GrpcServiceGrpc.getQuerySongsMethod) == null) {
      synchronized (GrpcServiceGrpc.class) {
        if ((getQuerySongsMethod = GrpcServiceGrpc.getQuerySongsMethod) == null) {
          GrpcServiceGrpc.getQuerySongsMethod = getQuerySongsMethod =
              io.grpc.MethodDescriptor.<team.burden.music.protos.Grpc.QuerySongsRequest, team.burden.music.protos.Grpc.QuerySongsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "querySongs"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.QuerySongsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  team.burden.music.protos.Grpc.QuerySongsResponse.getDefaultInstance()))
  ...
  public static abstract class GrpcServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void querySongs(team.burden.music.protos.Grpc.QuerySongsRequest request,
        io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.QuerySongsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                team.burden.music.protos.Grpc.QuerySongsRequest,
                team.burden.music.protos.Grpc.QuerySongsResponse>(
  ...
  public static final class GrpcServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GrpcServiceBlockingStub> {
    ...
    /**
     */
    public team.burden.music.protos.Grpc.QuerySongsResponse querySongs(team.burden.music.protos.Grpc.QuerySongsRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GrpcServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GrpcServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<team.burden.music.protos.Grpc.QuerySongsResponse> querySongs(
        team.burden.music.protos.Grpc.QuerySongsRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_QUERY_SONGS:
          serviceImpl.querySongs((team.burden.music.protos.Grpc.QuerySongsRequest) request,
              (io.grpc.stub.StreamObserver<team.burden.music.protos.Grpc.QuerySongsResponse>) responseObserver);
          break;
